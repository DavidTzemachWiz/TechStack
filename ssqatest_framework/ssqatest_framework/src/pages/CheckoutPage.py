...
from ssqatest_framework.src.pages.Locators.CheckoutPageLocators import CheckoutPageLocators
from ssqatest_framework.src.helpers import Random_email_Generaitor
...
class CheckoutPage(CheckoutPageLocators):
    ...
    def input_billing_email(self, email=None):
        if not email:
            rand_email = Random_email_Generaitor()
